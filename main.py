...
if needs_preprocess:
    preprocessor = NIfTIPreprocessor(IMG_WIDTH, IMG_HEIGHT, IMG_CHANNELS, TRAIN_PATH, TEST_PATH,
                                     PREPROCESSED_TRAIN_PATH, PREPROCESSED_TEST_PATH, TEST_DATA_LABELED)
    preprocessor.preprocess()

model = UnetModel(IMG_CHANNELS,
                  TRAIN_PATH,
                  TEST_PATH,
